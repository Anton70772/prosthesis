...
--
-- Host: localhost    Database: protez
-- ------------------------------------------------------
...
INSERT INTO `appointments` VALUES (1,'2024-05-17 10:00:00',102,'Прием завершен',2,2,2),(2,'2024-04-11 11:00:00',103,'Прием завершен',1,3,3),(3,'2024-06-18 12:00:00',104,'Прием завершен',3,4,4),(4,'2024-07-29 13:00:00',105,'Прием завершен',1,5,5),(5,'2024-08-31 14:00:00',106,'Прием завершен',3,6,6),(6,'2024-05-15 15:00:00',107,'Запись отменена',2,7,7),(7,'2024-07-07 17:10:00',123,'Прием завершен',1,1,1),(8,'2024-05-17 10:00:01',124,'Запись назначена',1,2,3);
...
INSERT INTO `doctors` VALUES (1,'Адамс Юлия Сергеевна','Главный хирург-протезист','2015-09-21','+71234567892'),(2,'Михайлов Владимир Петрович','Врач-хирург','2010-05-18','+71234167892'),(3,'Коваленко Олег Васильевич','Врач-протезист','2012-09-15','+71294567892'),(4,'Иванова Анна Николаевна','Главный хирург-протезист','2008-04-19','+71234567893'),(5,'Петрова Елена Дмитриевна','Врач-хирург','2006-11-27','+71234567894'),(6,'Смирнов Сергей Игоревич','Главный хирург-протезист','2010-06-23','+71234567895'),(7,'Козлова Мария Алексеевна','Техник-протезист','2007-12-27','+71234567896'),(8,'Никитина Антонина Владимировна','Ассистент хирурга','2009-10-11','+71234567897'),(9,'Соколов Игорь Александрович','Специалист по наноимплантам','2011-08-29','+71234567898'),(10,'Федорова Татьяна Сергеевна','Ассистент хирурга','2014-07-18','+71234567899');
...
INSERT INTO `patients` VALUES (1,'Сидоров Артем Николаевич','2001-08-15','М','+71234567893','artem@yandex.ru'),(2,'Петрова Мария Дмитриевна','1998-03-20','Ж','+71294567893','maria@yandex.ru'),(3,'Иванов Иван Иванович','1998-03-20','Ж','+71294567893','ivan@yandex.ru'),(4,'Петров Петр Петрович','1998-03-20','Ж','+71294567893','petr@yandex.ru'),(5,'Сидоров Сидор Сидорович','1998-03-20','Ж','+71294567893','sidor@yandex.ru'),(6,'Козлов Александр Александрович','1995-12-28','М','+71231567893','alexander@yandex.ru');
...
CREATE TABLE `services_reports` (
  ...
  KEY `fk_services_reports_patients1_idx` (`patients_id`),
  CONSTRAINT `fk_reports_doctors1` FOREIGN KEY (`doctors_id`) REFERENCES `doctors` (`id`),
  CONSTRAINT `fk_services_reports_patients1` FOREIGN KEY (`patients_id`) REFERENCES `patients` (`id`),
...
INSERT INTO `services_reports` VALUES (1,'2024-04-15 00:00:00','Операция прошла успешно, пациент себя чувствует хорошо, рекомендован курс реабилитации.',1,1,1),(2,'2024-05-18 00:00:00','Пациенту требуется последующее наблюдение и курс восстановительных мероприятий.',2,2,2),(3,'2024-06-20 00:00:00','Ожидается полное восстановление функций кисти, а так же необходимо пройти курс реабилитации.',3,3,3),(4,'2024-07-22 00:00:00','Процесс адаптации к новым возможностям проходит без осложнений.',4,4,4),(5,'2024-08-25 00:00:00','Пациент замечает улучшения в памяти и внимании после установки интерфейса.',5,5,5),(6,'2024-09-25 00:00:00','Процесс адаптации проходит успешно, все функции работают в норме',7,9,6),(7,'2024-10-16 00:00:00','Пациент четко видит слова на расстоянии более 500 метров, оттаржения не наблюдается',1,5,1),(8,'2024-11-19 00:00:00','Требуется дополнительная исследовательская работа для оптимизации параметров.',2,3,2),(9,'2024-12-21 00:00:00','Наблюдается улучшение функций сердца после процедуры.',4,9,3),(10,'2024-12-23 00:00:00','Наблюдается значительное увеличение мобильности после процедуры.',1,8,4),(11,'2024-07-07 13:55:37','В результате консультации пациенту будет заказан протез.',1,1,1),(13,'2024-08-31 14:30:00','Пациенту будет назначена операция через 2 недели',4,4,3),(14,'2024-07-07 17:30:00','По результатам консультации пациенту отложена операция ещё на 2 недели из за риска отторжения импланта.',1,1,1),(15,'2024-07-07 17:30:00','По результатам консультации операция для пациента отложена ещё на 2 недели из за высокого риска отторжения импланта.',1,1,1);
...
--
-- Dumping events for database 'protez'
--

--
-- Dumping routines for database 'protez'
--
...
-- Dump completed on 2024-06-13 12:25:43
